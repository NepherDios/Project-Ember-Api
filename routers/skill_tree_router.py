...
from crud.skill_tree import create_skill_tree, get_player_skill_trees, update_skill_tree, delete_skill_tree
...
def get_player_skilltrees_route(player_id: int, db: Session = Depends(get_db)):
    skill_trees = get_player_skill_trees(db, player_id)
    return [
        SkilltreeResponse(
